...
GitHub repository (issues, pull requests, discussions, code review), the
PLCCursos community Discord, project-related email, and any other
community channels.

It also applies when an individual is officially representing the community
in public spaces (e.g., using an official email address, posting via an
...
_Adapted with ❤️ for the Genius Automation community._